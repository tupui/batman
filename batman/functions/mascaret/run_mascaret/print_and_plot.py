...
def histogram(results, xlab='Quantity of interest', ylab='Density', title='Histogram with a kernel density estimator'):
    ...
    title_font = {'fontname':'sans-serif', 'size':'16', 'color':'black', 'weight':'normal', 'verticalalignment':'bottom'}
    ...
    plt.ylabel(ylab)
    fig.tight_layout()
    fig.savefig('./histo_waterlevel.pdf', transparent = True, bbox_inches='tight')
    plt.close('all')
